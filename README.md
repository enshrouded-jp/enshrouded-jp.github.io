...
- 開発元: Keen Games（ドイツ）
- ジャンル: voxel系サバイバル / クラフト / アクションRPG（三人称、建築時のみ一人称切替可）
...
### 装備・武器
- [装備概要](equipment/index.html) — [武器一覧](equipment/weapons.md) / [防具一覧](equipment/armor.md) / [レジェンダリー装備](equipment/legendaries.md)

### 素材・アイテム
- [素材概要](resources/index.html) — [採集素材](resources/gathering.md) / [鉱石・インゴット](resources/ores-ingots.md) / [加工素材](resources/processed.md)

### 建築
- [建築概要](building/index.html) — [建築システム](building/system.md) / [Adventure Sharing](building/adventure-sharing.md)

### Shroud（霧）
- [Shroud概要](shroud/index.html) — [Shroud Roots / Cores](shroud/roots-cores.md)

### 生存者（NPC）
- [生存者概要](survivors/index.html) — [Blacksmith](survivors/blacksmith.md) / [Hunter](survivors/hunter.md) / [Alchemist](survivors/alchemist.md) / [Farmer](survivors/farmer.md) / [Carpenter](survivors/carpenter.md)

### クエスト・ストーリー
- [クエスト概要](quests/index.html) — [メインクエスト](quests/main.md) / [サイドクエスト](quests/side.md) / [Ancient Vaults](quests/ancient-vaults.md)
